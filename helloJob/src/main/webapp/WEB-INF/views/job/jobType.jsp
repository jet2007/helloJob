...
<body>
	...
	<div  id="addJobType"  class="easyui-dialog" title="业务类型" style="width:700px;height:300px;padding:10px"
		...
		<div>命令<input id="cmd"  class="easyui-textbox"  data-options="required:true" prompt="请输入要执行的命令(demo)&#13;hive -e &quot;%s&quot; " style="width:700px;height:120px"/>	</div>
